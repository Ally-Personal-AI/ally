"""Safe service lifecycle and health models."""
...
class ServiceCycleRunRecord(BaseModel):
    """Payload-free lifecycle metadata for one proactive cycle attempt."""
...
class ServiceHealthReport(BaseModel):
    """Local health snapshot without private runtime payloads."""
