...
| Proactivity | Implemented substrate | persisted events, deterministic attention, scheduling, delivery, restart-safe sources, bounded lease-protected service cycle |
