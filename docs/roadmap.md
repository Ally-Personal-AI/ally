...
| Proactivity | Implemented substrate | persisted events, deterministic attention, scheduling, reliable interface-neutral delivery |
...
5. add external event sources, an OS scheduler service, and platform notification sinks on the persisted proactivity substrate;
6. add voice;
