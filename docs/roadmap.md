...
| Dedicated-hardware validation | Ready to run | versioned capability evidence, separate runtime privacy qualification, neutral comparison, behavioral qualification, and first-machine runbook |
