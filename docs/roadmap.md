...
| Personal knowledge | Implemented V1.3 + lifecycle controls | versioned plain-text ingestion, deterministic BM25 retrieval/grounding, native note/file capture, and explicit exact-ID source deletion cascading revisions/chunks; semantic/hybrid retrieval remains future |
