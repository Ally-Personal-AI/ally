...
| Proactivity | Implemented substrate | persisted events, deterministic attention, scheduling, delivery, bounded service-cycle runtime |
...
5. add external event sources, thin OS service wrappers, and platform notification sinks on the persisted proactivity substrate;
6. add voice;
