...
| Dedicated-hardware validation | Ready to run | read-only first-machine readiness preflight, disposable synthetic end-to-end workflow validation, versioned capability evidence, path-free model/runtime artifact fingerprints, separate runtime privacy qualification, cryptographically verified candidate pairing/comparison, behavioral qualification, and first-machine runbook |
